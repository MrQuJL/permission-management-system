		...
		<c:if test="${menu.parentId eq parentId && menu.isShow eq '1'}">
			<div class="accordion-group">
				...
				<div id="collapse-${menu.id}"
					class="accordion-body ${first ? 'in' : ''} collapse">
									...
									<li><a data-href=".menu3-${menu2.id}"
										...
										<ul class="nav nav-list hide"
											...
											<c:forEach items="${menuList}" var="menu3">
												<c:if
													test="${menu3.parentId eq menu2.id && menu3.isShow eq '1'}">
													<li class="menu3-${menu3.id} hide"><a
														data-href=".menu3-${menu3.id}" href="${ctx}${menu3.href}"
