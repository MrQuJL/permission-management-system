   ...
   implements java.io.Serializable 
{
   ...
   public void copyAccountViewsFrom(test.interfaces.CustomerValue from)
   {
	  // TODO Clone the List ????
   ...
   public void copyShippingAddressValuesFrom(test.interfaces.CustomerValue from)
   {
	  // TODO Clone the List ????
   ...
   public String toString()
   {
	  ...
	  str.append("credit=" + getCredit() + " " + "array=" + getArray() + " " + "image=" + getImage() + " " + "tax=" + getTax() + " " + "id=" + getId() + " " + "name=" + getName() + " " + "firstName=" + getFirstName() + " " + "phone=" + getPhone() + " " + "fax=" + getFax());
	  str.append(",version=");
	  str.append(_version);
	  str.append('}');
